// ======================================================================
// fa20_i2s_streamer.v generated from TopDesign.cysch
// 07/27/2020 at 17:42
...
// I2S_v2_70(ClipPresent=false, ClockSyncMode=true, CommonClipThresholds=false, DataBits=16, Direction=3, EnableClipDetect=false, EnableRxByteSwap=false, EnableTxByteSwap=false, InterruptSource=18, NegThresholds=-1, NumRxChannels=2, NumRxLines=1, NumTxChannels=2, NumTxLines=1, PosThresholds=0u, RxDataInterleaved=true, RxDataInterleaving=1, RxDMA_present=2, RxDmaPresent=false, RxInterruptSource=2, RxStsReg0Present=true, RxStsReg1Present=false, RxStsReg2Present=false, StaticBitResolution=true, TermVisibility_clip=false, TermVisibility_clock=true, TermVisibility_rx_dma0=false, TermVisibility_rx_dma1=false, TermVisibility_rx_interrupt=true, TermVisibility_sck=true, TermVisibility_sdi=true, TermVisibility_sdo=true, TermVisibility_tx_dma0=false, TermVisibility_tx_dma1=false, TermVisibility_tx_interrupt=true, TermVisibility_ws=true, TxDataInterleaved=true, TxDataInterleaving=1, TxDMA_present=2, TxDmaPresent=false, TxInterruptSource=2, TxStsReg0Present=true, TxStsReg1Present=false, TxStsReg2Present=false, WordSelect=32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=I2S_v2_70, CY_CONFIG_TITLE=I2S, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=I2S, CY_INSTANCE_SHORT_NAME=I2S, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=I2S, )
module I2S_v2_70_0 (
    clock,
    sdi,
    sck,
...
module top ;
	...
	wire [0:0] tmpOE__I2S_SD_IN_net;
	wire [0:0] tmpIO_0__I2S_SD_IN_net;
	wire [0:0] tmpINTERRUPT_0__I2S_SD_IN_net;
	electrical [0:0] tmpSIOVREF__I2S_SD_IN_net;
	...
	cy_psoc3_pins_v1_10
		...
		I2S_SD_IN
		 (.oe(tmpOE__I2S_SD_IN_net),
		  .y({1'b0}),
		  .fb({Net_60}),
		  .io({tmpIO_0__I2S_SD_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__I2S_SD_IN_net),
		  .interrupt({tmpINTERRUPT_0__I2S_SD_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I2S_SD_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__I2S_WS_OUT_net;
	wire [0:0] tmpFB_0__I2S_WS_OUT_net;
	wire [0:0] tmpIO_0__I2S_WS_OUT_net;
	wire [0:0] tmpINTERRUPT_0__I2S_WS_OUT_net;
	electrical [0:0] tmpSIOVREF__I2S_WS_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0412e7a3-7bb2-4490-8a7d-0675b098c5ba"),
		  ...
		  .input_buffer_sel(2'b00))
		I2S_WS_OUT
		 (.oe(tmpOE__I2S_WS_OUT_net),
		  .y({Net_29}),
		  .fb({tmpFB_0__I2S_WS_OUT_net[0:0]}),
		  .io({tmpIO_0__I2S_WS_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__I2S_WS_OUT_net),
		  .interrupt({tmpINTERRUPT_0__I2S_WS_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I2S_WS_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__I2S_SCK_OUT_net;
	wire [0:0] tmpFB_0__I2S_SCK_OUT_net;
	wire [0:0] tmpIO_0__I2S_SCK_OUT_net;
	wire [0:0] tmpINTERRUPT_0__I2S_SCK_OUT_net;
	electrical [0:0] tmpSIOVREF__I2S_SCK_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c8e19693-67d9-4f29-a02f-cee5400c223a"),
		  ...
		  .input_buffer_sel(2'b00))
		I2S_SCK_OUT
		 (.oe(tmpOE__I2S_SCK_OUT_net),
		  .y({Net_28}),
		  .fb({tmpFB_0__I2S_SCK_OUT_net[0:0]}),
		  .io({tmpIO_0__I2S_SCK_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__I2S_SCK_OUT_net),
		  .interrupt({tmpINTERRUPT_0__I2S_SCK_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I2S_SCK_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__I2S_SD_OUT_net;
	wire [0:0] tmpFB_0__I2S_SD_OUT_net;
	wire [0:0] tmpIO_0__I2S_SD_OUT_net;
	wire [0:0] tmpINTERRUPT_0__I2S_SD_OUT_net;
	electrical [0:0] tmpSIOVREF__I2S_SD_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		I2S_SD_OUT
		 (.oe(tmpOE__I2S_SD_OUT_net),
		  .y({Net_30[0:0]}),
		  .fb({tmpFB_0__I2S_SD_OUT_net[0:0]}),
		  .io({tmpIO_0__I2S_SD_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__I2S_SD_OUT_net),
		  .interrupt({tmpINTERRUPT_0__I2S_SD_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I2S_SD_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("7420302c-7b24-4bac-afed-ef097446133d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__OUT_ADC_INT_net;
	wire [0:0] tmpFB_0__OUT_ADC_INT_net;
	wire [0:0] tmpIO_0__OUT_ADC_INT_net;
	wire [0:0] tmpINTERRUPT_0__OUT_ADC_INT_net;
	electrical [0:0] tmpSIOVREF__OUT_ADC_INT_net;

	cy_psoc3_pins_v1_10
		#(.id("bfb7501a-d3e5-4983-b3d1-7f3b6bd9a4ae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_ADC_INT
		 (.oe(tmpOE__OUT_ADC_INT_net),
		  .y({Net_56}),
		  .fb({tmpFB_0__OUT_ADC_INT_net[0:0]}),
		  .io({tmpIO_0__OUT_ADC_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_ADC_INT_net),
		  .interrupt({tmpINTERRUPT_0__OUT_ADC_INT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_ADC_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT_I2S_WS_net;
	wire [0:0] tmpFB_0__OUT_I2S_WS_net;
	wire [0:0] tmpIO_0__OUT_I2S_WS_net;
	wire [0:0] tmpINTERRUPT_0__OUT_I2S_WS_net;
	electrical [0:0] tmpSIOVREF__OUT_I2S_WS_net;

	cy_psoc3_pins_v1_10
		#(.id("c6a4aa79-ff63-450c-acc8-5adbaed3f38d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OUT_I2S_WS
		 (.oe(tmpOE__OUT_I2S_WS_net),
		  .y({Net_29}),
		  .fb({tmpFB_0__OUT_I2S_WS_net[0:0]}),
		  .io({tmpIO_0__OUT_I2S_WS_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT_I2S_WS_net),
		  .interrupt({tmpINTERRUPT_0__OUT_I2S_WS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT_I2S_WS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4150b500-545f-4ed6-93dc-ae460ca32d11"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9af446de-404c-4cdd-b2a2-3e533cd55282"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("881fd031-bc2a-48e9-9565-c9f72a765c3a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
